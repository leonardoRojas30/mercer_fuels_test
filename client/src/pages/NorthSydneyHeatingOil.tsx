            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center w-full">
              ...
              <div className="text-white space-y-6">
                ...
                <div className="flex gap-4">
                  <Button size="lg" data-testid="button-call-north-sydney" asChild>
                    <a href="tel:902-539-4242">
                      <Phone className="mr-2 h-5 w-5" />
                      Call (902) 539-4242
                    </a>
                  </Button>
                  <Button size="lg" variant="outline" data-testid="button-consultation-north-sydney" asChild>
              ...
              {/* Quick Contact Form */}
              <Card className="max-w-md ml-auto" data-testid="card-contact-north-sydney">
                <CardHeader>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 lg:px-6 text-center">
          ...
          <div className="flex justify-center gap-4">
            <Button size="lg" variant="secondary" data-testid="button-call-cta-north-sydney" asChild>
              <a href="tel:902-539-4242">
                <Phone className="mr-2 h-5 w-5" />
                Call (902) 539-4242
              </a>
            </Button>
            <Button size="lg" variant="outline" data-testid="button-consultation-cta-north-sydney" asChild>
              <Link href="/schedule-consultation">
