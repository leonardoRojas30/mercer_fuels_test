    ...
    <div className="min-h-screen">
      ...
      <section className="relative">
        ...
        >
          ...
          <div className="relative z-10 container mx-auto px-2 md:px-4 lg:px-6 flex items-start justify-center pt-[60px] pb-8 md:pt-20 md:pb-12 lg:pt-20 lg:justify-start lg:items-center">
