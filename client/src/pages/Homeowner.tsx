...
type HomeownerForm = z.infer<typeof homeownerSchema>;

export default function Homeowner() {
  const [isFormSubmitted, setIsFormSubmitted] = useState(false);
  const { toast } = useToast();

  const form = useForm<HomeownerForm>({
  ...
  useEffect(() => {
    ...
    if (existingScript) {
      if (window.jotformEmbedHandler) {
        window.jotformEmbedHandler("iframe[id='JotFormIFrame-232193796168266']", "https://pci.jotform.com/");
      }
      return;
    }
  ...
  const onSubmit = async (data: HomeownerForm) => {
    try {
      const response = await fetch('/api/homeowner-interest', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: result.message || "We'll contact you soon about your $150 homeowner bonus.",
        });
        form.reset();
      } else {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Welcome Homeowners - $150 Bonus | Mercer Fuels Cape Breton</title>
        <meta name="description" content="Claim your $150 homeowner bonus from Mercer Fuels. Automatic delivery, homeowners auto-approved, 200+ 5-star reviews. Serving Sydney & Glace Bay, Nova Scotia." />
              ...
              <div className="lg:ml-auto w-full max-w-md">
                <Card className="bg-white shadow-2xl border-0">
                  <CardHeader className="pb-4">
                    <CardTitle className="text-2xl font-bold text-center">Claim Your $150 Bonus</CardTitle>
                    ...
                    {isFormSubmitted ? (
                      <div className="text-center py-8 space-y-4" data-testid="success-message">
                        ...
                        <p className="text-gray-600">
                          We'll contact you soon to complete your setup and confirm your $150 bonus!
                        </p>
                      </div>
                    ) : (
                      <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                          ...
                          <p className="text-xs text-center text-muted-foreground">
                            We'll call you to complete setup and confirm your $150 bonus
                          </p>
                        </form>
                      </Form>
                    )}
        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Why Homeowners Choose Mercer Fuels
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We make it easy to keep your home warm and comfortable
            </p>
          </div>
      ...
      <section id="claim-options" className="py-16 bg-white">
        <div className="container mx-auto px-4 lg:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              Three Easy Ways to Claim Your $150 Bonus
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto mb-12">
            ...
            <Card className="bg-white shadow-lg" data-testid="card-option-signup">
              <CardHeader className="text-center pb-4">
                <CardTitle className="text-2xl font-bold">Complete Signup</CardTitle>
                <CardDescription className="text-base">
                  Set everything up online right now
                </CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col items-center justify-center py-6">
                <Home className="w-16 h-16 text-chart-2 mb-6" />
                <p className="text-lg text-muted-foreground mb-6 text-center">
                  Fill out our complete signup form to get started immediately
                </p>
                <Button 
                  asChild
                  size="lg"
          ...
          {/* JotForm Embedded - Complete Signup */}
          <div id="signup-form" className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-6">
            <h3 className="text-2xl font-bold text-center mb-6">Complete Customer Sign Up Form</h3>
            <iframe
              id="JotFormIFrame-232193796168266"
              title="Mercer Fuels - Customer Sign Up [$150 Homeowner Bonus]"
              onLoad={(e) => {
              ...
              src="https://pci.jotform.com/form/232193796168266"
              style={{
                minWidth: '100%',
                maxWidth: '100%',
                height: '539px',
