        ...
        <div className="container mx-auto px-4 lg:px-6">
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="space-y-2">
              ...
              <h3 className="text-3xl font-bold text-primary">Daily Price Checks</h3>
            ...
            <div className="space-y-2">
              ...
              <h3 className="text-3xl font-bold text-primary">50+ Years Local</h3>
            ...
            <div className="space-y-2">
              ...
              <h3 className="text-3xl font-bold text-primary">No Hidden Costs</h3>
